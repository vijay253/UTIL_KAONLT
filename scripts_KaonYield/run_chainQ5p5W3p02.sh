...
if [[ ${epsilon} = "low" ]]; then
	...
	mv ../OUTPUT/Kinematics_1uA_allPlots.pdf ../OUTPUT/Q5.5_W3.02_x0.40_lowe/Kinematics_leftQ5p5W3p02.pdf
	...
	echo "Running ${script_Q5p5W3p02}"
	eval ${run_script_Q5p5W3p02}
	mv ../OUTPUT/Kinematics_1uA_allPlots.pdf ../OUTPUT/Q5.5_W3.02_x0.40_lowe/Kinematics_centerQ5p5W3p02.pdf
...
if [[ ${epsilon} = "high" ]]; then
	...
	echo "Running ${script_Q5p5W3p02}"
	eval ${run_script_Q5p5W3p02}
	mv ../OUTPUT/Kinematics_1uA_allPlots.pdf ../OUTPUT/Q5.5_W3.02_x0.40_highe/Kinematics_leftQ5p5W3p02.pdf
	...
	echo "Running ${script_Q5p5W3p02}"
	eval ${run_script_Q5p5W3p02}
	mv ../OUTPUT/Kinematics_1uA_allPlots.pdf ../OUTPUT/Q5.5_W3.02_x0.40_highe/Kinematics_centerQ5p5W3p02.pdf
	...
	echo "Running ${script_Q5p5W3p02}"
	eval ${run_script_Q5p5W3p02}
	mv ../OUTPUT/Kinematics_1uA_allPlots.pdf ../OUTPUT/Q5.5_W3.02_x0.40_highe/Kinematics_rightQ5p5W3p02.pdf
