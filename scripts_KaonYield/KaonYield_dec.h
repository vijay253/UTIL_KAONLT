...
#ifndef KaonYield_dec_h
#define KaonYield_dec_h
...
class KaonYield_dec : public TSelector {
 public :
  ...
  ClassDef(KaonYield_dec,0);

};

#endif

#ifdef KaonYield_dec_cxx
void KaonYield_dec::Init(TTree *tree)
{
