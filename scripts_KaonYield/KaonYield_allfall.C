#define KaonYield_allfall_cxx
// The class definition in KaonYield_allfall.h has been generated automatically
...
//
// root> T->Process("KaonYield_allfall.C")
// root> T->Process("KaonYield_allfall.C","some options")
// root> T->Process("KaonYield_allfall.C+")
//


#include "KaonYield_allfall.h"
#include <TStyle.h>
#include <TCanvas.h>
#include <TLine.h>
#include <TMath.h>
...
void KaonYield_allfall::Begin(TTree * /*tree*/)
{
...
void KaonYield_allfall::SlaveBegin(TTree * /*tree*/)
{
  ...
  // h2WvsQ2                 = new TH2F("WvsQ2","Q2 vs W;Q2;W",480,2.0,4.0,200,2.0,1.0);//Q3,w2.32
...
Bool_t KaonYield_allfall::Process(Long64_t entry)
{
  ...
  //   if ( (CTime_eKCoinTime_ROC1[0] - 43) > -1. && (CTime_eKCoinTime_ROC1[0] - 43) < 1.0) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //     h1mmisspiK_cut->Fill(sqrt(pow(emiss[0],2)-pow(pmiss[0],2)));
  ...
  //     h1mmisspiK_rand->Fill(sqrt(pow(emiss[0],2)-pow(pmiss[0],2)));
  //     h1mmisspiK_remove->Fill(sqrt(pow(emiss[0],2)-pow(pmiss[0],2)));
  //   }
  //   //////////
...
void KaonYield_allfall::SlaveTerminate()
{
...
void KaonYield_allfall::Terminate()
{
  ...
  // GausBack->SetParLimits(3,1.08,1.11);
