#define HMS_Scalers_cxx
// The class definition in HMS_Scalers.h has been generated automatically
...
//
// root> T->Process("HMS_Scalers.C")
// root> T->Process("HMS_Scalers.C","some options")
// root> T->Process("HMS_Scalers.C+")
//


#include "HMS_Scalers.h"
#include <TH2.h>
#include <TStyle.h>


void HMS_Scalers::Begin(TTree * /*tree*/)
{
...
void HMS_Scalers::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t HMS_Scalers::Process(Long64_t entry)
{
...
void HMS_Scalers::SlaveTerminate()
{
...
void HMS_Scalers::Terminate()
{
  ...
  for (Int_t itrig = 0; itrig < NTRIG; itrig++) {
    cout << Form("%s counts: %.0f, Pretrigger: %.0f, Computer Livetime: %f +/- %f",trig_name[itrig].c_str(), acctrig_sum, trig_sum[itrig], acctrig_sum/trig_sum[itrig], (acctrig_sum/trig_sum[itrig])*sqrt((1/trig_sum[itrig])+(1/acctrig_sum))) << endl;
  }
