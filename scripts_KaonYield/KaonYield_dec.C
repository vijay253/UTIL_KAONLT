...
void KaonYield_dec::SlaveBegin(TTree * /*tree*/)
{
  ...
  // h1missKcut_CT   = new TH2F("h1missKcut_CT","Kaon Missing mass vs SHMS #delta;SHMS #delta;Mass (GeV/c^{2})^{2}",400,-20,20,100,0.8,1.8);
