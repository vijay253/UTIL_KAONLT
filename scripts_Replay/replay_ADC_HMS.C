void replay_ADC_HMS(Int_t RunNumber=0, Int_t MaxEvent=0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/ADCGates_HMS_coin_replay_production_all_%d_%d.root";
  ...
  // Define cuts file
  analyzer->SetCutFile("UTIL_KAONLT/scripts_Replay/ADCGates_HMS_cuts.def");    // optional
