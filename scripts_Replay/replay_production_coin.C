void replay_production_coin (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/KaonLT_coin_replay_production_%d_%d.root";
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("UTIL_KAON/scripts_Replay/coin_production.def");
  // Define cuts file
  analyzer->SetCutFile("UTIL_KAON/scripts_Replay/coin_production_cuts.def");  // optional
