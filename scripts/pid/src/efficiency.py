...
# SHMS info
CTime_ePositronCoinTime_ROC1    = e_tree.array("CTime.ePositronCoinTime_ROC1")
...
def SHMS_events(): 
    NoCut_Events_SHMS = [P_gtr_beta, P_gtr_xp, P_gtr_yp, P_gtr_p, P_gtr_dp, P_cal_etotnorm, P_aero_npeSum, P_hgcer_npeSum, P_hgcer_xAtCer, P_hgcer_yAtCer, CTime_ePositronCoinTime_ROC1, CTime_eKCoinTime_ROC1]
    SHMS_Events_Info = [(PBeta, Pxp, Pyp, PP, PDel, Ptot, Paernpe, Phgnpe, Pxat, Pyat, CTimeP, CTimeK) for (PBeta, Pxp, Pyp, PP, PDel, Ptot, Paernpe, Phgnpe, Pxat, Pyat, CTimeP, CTimeK) in zip(*NoCut_Events_SHMS)]
    ...
    Cut_Events_SHMS_Cut1_Info = [(PBeta, Pxp, Pyp, PP, PDel, Ptot, Paernpe, Phgnpe, Pxat, Pyat, CTimeP, CTimeK) for (PBeta, Pxp, Pyp, PP, PDel, Ptot, Paernpe, Phgnpe, Pxat, Pyat, CTimeP, CTimeK) in zip(*Cut_Events_SHMS_Cut1_tmp)]
    Cut_Events_SHMS_Cut2_Info = [(PBeta, Pxp, Pyp, PP, PDel, Ptot, Paernpe, Phgnpe, Pxat, Pyat, CTimeP, CTimeK) for (PBeta, Pxp, Pyp, PP, PDel, Ptot, Paernpe, Phgnpe, Pxat, Pyat, CTimeP, CTimeK) in zip(*Cut_Events_SHMS_Cut2_tmp)]
...
def main():
    ...
    SHMS_Data_Header = ["P_gtr_beta","P_gtr_xp","P_gtr_yp","P_gtr_p","P_gtr_dp","P_cal_etotnorm", "P_aero_npeSum", "P_hgcer_npeSum", "P_hgcer_xAtCer", "P_hgcer_yAtCer", "CTime_ePositronCoinTime_ROC1", "CTime_eKCoinTime_ROC1"]
