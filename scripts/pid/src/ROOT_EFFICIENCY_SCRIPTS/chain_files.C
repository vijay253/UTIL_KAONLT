...
void chain_files(string RunPrefix = "", Int_t NumEvents = 0, Int_t nRuns = 0, Int_t RunNumber1 = 0, Int_t RunNumber2 = 0, Int_t RunNumber3 = 0, Int_t RunNumber4 = 0, Int_t RunNumber5 = 0, Int_t RunNumber6 = 0, Int_t RunNumber7 = 0, Int_t RunNumber8 = 0, Int_t RunNumber9 = 0, Int_t RunNumber10 = 0)
{
