...
inputFile="/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLT/scripts/pid/batch/inputRuns" 
...
while true; do
    ...
    case $yn in
		...
		#echo "TIME: 1" >> ${batch} 
		echo "COMMAND:/group/c-pionlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLT/scripts/pid/replay_pid.sh ${runNum}" >> ${batch}                                                        
