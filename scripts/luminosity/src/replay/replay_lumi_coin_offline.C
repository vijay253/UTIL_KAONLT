void replay_lumi_coin_offline(Int_t RunNumber = 0, Int_t MaxEvent = 0) {
...
analyzer->PrintReport("UTIL_KAONLT/config/TEMPLATES/lumi_coin.template",
		    Form("UTIL_KAONLT/REPORT_OUTPUT/Analysis/Lumi/lumi_coin_offline_%d_%d.report", RunNumber, MaxEvent)); // optional
