void replay_elastics_shms(Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/shms_coin_replay_elastics_%d_%d.root";
  ...
  analyzer->PrintReport("TEMPLATES/SHMS/PRODUCTION/pstackana_production.template",
  			Form("REPORT_OUTPUT/SHMS/PRODUCTION/replay_shms_coin_elastics_%d_%d.report", RunNumber, MaxEvent));  // optional
