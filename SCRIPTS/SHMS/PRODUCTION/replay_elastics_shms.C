void replay_elastics_shms (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/shms_replay_elastics_%d_%d.root";
...
THcScalerEvtHandler* pscaler = new THcScalerEvtHandler("P", "Hall C scaler event type 1");
  ...
  */
  ...
  // Define cuts file
  analyzer->SetCutFile("DEF-files/SHMS/PRODUCTION/pstackana_elastics_cuts.def");  // optional
  ...
  analyzer->PrintReport("TEMPLATES/SHMS/PRODUCTION/pstackana_production.template",
  			Form("REPORT_OUTPUT/SHMS/PRODUCTION/replay_shms_elastics_%d_%d.report", RunNumber, MaxEvent));  // optional
