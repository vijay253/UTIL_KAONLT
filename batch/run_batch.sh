...
##### A batch submission script by Richard, replace USER with your username and insert the required script you want to batch run on line 51 too
...
##Input run numbers##
inputFile="/u/group/c-kaonlt/hallc_replay_kaonlt/UTIL_KAONLT/batch/inputRuns"
...
while true; do
    ...
    case $yn in
		...
		echo ""
		#eval "jcache pendingRequest USER 2>/dev/null"
		##Run number#
		runNum=$line
		tmp=tmp 
		...
		echo "CPU: 2" >> ${batch}
		#echo "TIME: 1" >> ${batch}
		echo "COMMAND:/u/group/c-kaonlt/USERS/USER/hallc_replay_kaonlt/UTIL_KAONLT/SCRIPT.sh ${runNum}" >> ${batch}
