...
inputFile="/u/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLT/batch/inputRun_Templates/Carbon_ALL"
...
while true; do
    ...
    case $yn in
		...
		echo "COMMAND:/u/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/UTIL_KAONLT/DCCalib_Batch.sh ${runNum} ${SPEC} ${MAXEVENT}" >> ${batch} 
